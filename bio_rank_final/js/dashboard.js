...
window.openQuestionReportModal = function (questionData, qNumber) {
  ...
  modal.innerHTML = `
    <div style="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(15,23,42,0.7);backdrop-filter:blur(6px);-webkit-backdrop-filter:blur(6px);z-index:999999;display:flex;align-items:center;justify-content:center;padding:var(--sp-4);" onclick="if(event.target===this) document.getElementById('global-question-report-modal').remove();">
      <div style="max-width:500px;width:100%;background:#ffffff;color:#0f172a;box-shadow:0 25px 50px -12px rgba(0,0,0,0.45);border:1px solid var(--neutral-200);border-radius:var(--radius-xl);padding:var(--sp-6);animation:modalPop 0.2s cubic-bezier(0.34, 1.56, 0.64, 1);">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:var(--sp-4);border-bottom:1px solid var(--neutral-100);padding-bottom:var(--sp-3);">
          <div style="font-weight:800;font-size:var(--text-lg);color:#0f172a;display:flex;align-items:center;gap:8px;">
            ...
            <span>Report Question ${qNumber ? `#${qNumber}` : ''}</span>
          </div>
          <button class="btn btn-ghost btn-sm" onclick="document.getElementById('global-question-report-modal').remove()" style="font-size:18px;line-height:1;padding:4px 8px;border-radius:50%;color:var(--neutral-500);">✕</button>
        </div>
        ...
        <div style="font-size:var(--text-xs);color:#334155;margin-bottom:var(--sp-4);line-height:1.5;background:#f8fafc;padding:var(--sp-3);border-radius:var(--radius-md);border:1px solid #e2e8f0;border-left:4px solid var(--primary-600);">
          <strong style="color:var(--primary-800);display:block;margin-bottom:2px;">Question Text:</strong>
          "${escapeHtml(qText.length > 130 ? qText.substring(0, 130) + '…' : qText)}"
        </div>
        ...
        <form id="global-report-form" onsubmit="event.preventDefault(); window.submitGlobalQuestionReport('${qId}', '${(qText || '').replace(/'/g, "\\'")}');">
          <div class="form-group" style="margin-bottom:var(--sp-4);">
            ...
            <select class="form-select form-select-sm" id="global-report-reason" required style="width:100%;background:#ffffff;border:1.5px solid #cbd5e1;color:#0f172a;font-size:var(--text-sm);padding:8px 12px;border-radius:var(--radius-md);">
          ...
          <div class="form-group" style="margin-bottom:var(--sp-5);">
            ...
            <textarea class="form-input form-input-sm" id="global-report-comments" rows="3" placeholder="Explain what looks wrong so the admin team can verify and fix it…" style="width:100%;font-size:var(--text-xs);background:#ffffff;border:1.5px solid #cbd5e1;color:#0f172a;border-radius:var(--radius-md);line-height:1.4;padding:8px 12px;"></textarea>
          </div>

          <div style="display:flex;gap:var(--sp-3);justify-content:flex-end;border-top:1px solid var(--neutral-100);padding-top:var(--sp-4);">
            <button class="btn btn-secondary btn-sm" type="button" onclick="document.getElementById('global-question-report-modal').remove()">Cancel</button>
